        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <div className="space-x-4 pt-4">
              ...
              <button onClick={()=>navigate("/learnConsumer")} className="bg-white hover:bg-gray-100 text-green-700 px-8 py-3 rounded-lg font-semibold transition-colors duration-200">
                Learn More
